...
interface BoxContributionChartProps {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Money added vs taken out, by month</CardDescription>
      </CardHeader>
      <CardContent>
        {hasActivity ? (
          ...
          <div className="flex h-[300px] items-center justify-center text-sm text-muted-foreground">
            No activity yet — add money to this box to see the trend.
          </div>
        )}
      </CardContent>
    </Card>
