...
import { MessageSquare, Mic, Bell, FileText, BarChart3, Users } from 'lucide-react';
...
const cardData: BentoCardProps[] = [
  {
    color: '#060010',
    title: 'Natural Language Ledger',
    description: "Just type 'Gave 200 to Raju'",
    label: 'Chat to Record',
    icon: <MessageSquare className="w-6 h-6" />
  },
  {
    color: '#060010',
    title: 'Multi-Modal Inputs',
    description: 'Send voice notes or bills',
    label: 'Voice & OCR',
  ...
  },
  {
    ...
    description: 'Auto-reminders with UPI links',
    label: 'Automation',
  ...
  },
  {
    ...
    description: 'Auto-organize customers',
    label: 'Ledger',
